...
public class Xattribute1 extends Attribute{

	public Xattribute1(){
		super(new KMIPTextString("x-attribute1"), new EnumTag(EnumTag.CustomAttribute), new EnumType(EnumType.TextString));
	...
	public Xattribute1(KMIPType value) {
		this();
