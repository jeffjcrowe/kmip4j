...
public class Xattribute2 extends Attribute{

	public Xattribute2(){
		super(new KMIPTextString("x-attribute2"), new EnumTag(EnumTag.CustomAttribute), new EnumType(EnumType.TextString));
	...
	public Xattribute2(KMIPType value) {
		this();
