/**
 * PublicKeyTemplateAttribute.java
 * -----------------------------------------------------------------
...
public class PublicKeyTemplateAttribute extends TemplateAttributeStructure {
	
	public PublicKeyTemplateAttribute() {
		super(new EnumTag(EnumTag.PublicKeyTemplateAttribute));
	}	
