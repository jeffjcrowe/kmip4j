...
@Entity
@DiscriminatorValue("Operation Policy Name")
public class OperationPolicyName extends Attribute {
	
	public OperationPolicyName(){
		super("Operation Policy Name", "OperationPolicyName", "TextString");
		this.values = new ArrayList<KLMSAttributeValue>();
		this.values.add(new KLMSAttributeValue("TextString", "OperationPolicyName"));
		this.values.get(0).setName(this.getAttributeName());
	}
	
	public OperationPolicyName(String value){
		this();
