...
@Entity
@DiscriminatorValue("Compromise Date")
public class CompromiseDate extends Attribute {
	
	public CompromiseDate(){
		super("Compromise Date", "CompromiseDate", "DateTime");
		this.values = new ArrayList<KLMSAttributeValue>();
		this.values.add(new KLMSAttributeValue("DateTime", "CompromiseDate"));
		this.values.get(0).setName(this.getAttributeName());
	}
	
	public CompromiseDate(String value){
		this();
