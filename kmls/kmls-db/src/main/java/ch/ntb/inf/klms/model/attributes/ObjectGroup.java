...
@Entity
@DiscriminatorValue("Object Group")
public class ObjectGroup extends Attribute {
	
	
	public ObjectGroup(){
		super("Object Group", "ObjectGroup", "TextString");
		this.values = new ArrayList<KLMSAttributeValue>();
		this.values.add(new KLMSAttributeValue("TextString", "ObjectGroup"));
		this.values.get(0).setName(this.getAttributeName());
	}
	
	public ObjectGroup(String value){
		this();
