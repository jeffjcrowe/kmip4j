...
@Entity
@DiscriminatorValue("Compromise Occurrence Date")
public class CompromiseOccurrenceDate extends Attribute {
	
	public CompromiseOccurrenceDate(){
		super("Compromise Occurrence Date", "CompromiseOccurrenceDate", "DateTime");
		this.values = new ArrayList<KLMSAttributeValue>();
		this.values.add(new KLMSAttributeValue("DateTime", "CompromiseOccurrenceDate"));
		this.values.get(0).setName(this.getAttributeName());
	}
	
	public CompromiseOccurrenceDate(String value){
		this();
