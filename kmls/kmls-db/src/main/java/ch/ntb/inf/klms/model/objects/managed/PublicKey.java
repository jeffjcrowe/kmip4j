...
public class PublicKey extends CryptographicObject{
	...
	@JoinTable(
			name="PUBLICKEY_CRYPTOGRAPHICPARAMETERS",
		    joinColumns= @JoinColumn(name="PUBLICKEYKEY_ID", referencedColumnName="ID"),
	...
	public void setLink(String uniqueIdentifierValue) {
		...
		l.setValue(Integer.toString(EnumLinkType.PrivateKeyLink), "Link Type");
		links.add(l);
	}
}
