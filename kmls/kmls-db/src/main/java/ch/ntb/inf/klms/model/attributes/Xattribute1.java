...
@DiscriminatorColumn (name = "Xattribute1", discriminatorType = DiscriminatorType.STRING)
public class Xattribute1 extends CustomAttribute {
	
	public Xattribute1(){
		super("x-attribute1", "CustomAttribute", "TextString");
	...
	public Xattribute1(String value) {
		this();
